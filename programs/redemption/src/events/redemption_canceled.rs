...
impl EventDiscriminator for RedemptionCanceledEvent {
    const DISCRIMINATOR: u8 = RedemptionEventDiscriminators::RedemptionCanceled as u8;
}

impl EventSerialize for RedemptionCanceledEvent {
    #[inline(always)]
