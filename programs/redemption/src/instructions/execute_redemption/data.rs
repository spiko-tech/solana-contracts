...
/// Instruction data for the ExecuteRedemption instruction.
///
/// Data layout:
///   [0..32]  user address (32 bytes)
///   [32..40] amount (u64, little-endian)
///   [40..48] salt (u64, little-endian)
pub struct ExecuteRedemptionData {
    pub user: [u8; 32],
    pub amount: u64,
    pub salt: u64,
}

impl<'a> TryFrom<&'a [u8]> for ExecuteRedemptionData {
...
impl<'a> InstructionData<'a> for ExecuteRedemptionData {
    const LEN: usize = 48;
}
