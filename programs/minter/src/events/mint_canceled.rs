...
impl EventDiscriminator for MintCanceledEvent {
    const DISCRIMINATOR: u8 = MinterEventDiscriminators::MintCanceled as u8;
}

impl EventSerialize for MintCanceledEvent {
    #[inline(always)]
