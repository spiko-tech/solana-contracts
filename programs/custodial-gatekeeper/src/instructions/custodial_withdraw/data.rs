...
/// Instruction data for the CustodialWithdraw instruction.
///
/// Data layout:
///   [0..32]  recipient address (wallet owner, 32 bytes)
///   [32..40] amount (u64, little-endian)
///   [40..48] salt (u64, little-endian)
pub struct CustodialWithdrawData {
    pub recipient: [u8; 32],
    pub amount: u64,
    pub salt: u64,
}

impl<'a> TryFrom<&'a [u8]> for CustodialWithdrawData {
...
impl<'a> InstructionData<'a> for CustodialWithdrawData {
    const LEN: usize = 48;
}
