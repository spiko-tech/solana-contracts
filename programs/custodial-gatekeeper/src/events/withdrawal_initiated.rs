...
impl EventDiscriminator for WithdrawalInitiatedEvent {
    const DISCRIMINATOR: u8 = GatekeeperEventDiscriminators::WithdrawalInitiated as u8;
}

impl EventSerialize for WithdrawalInitiatedEvent {
    #[inline(always)]
